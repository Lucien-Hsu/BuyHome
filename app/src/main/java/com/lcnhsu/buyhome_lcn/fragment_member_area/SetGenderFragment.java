...
public class SetGenderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_set_gender, container, false);
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                switch (i) {
                    case R.id.rbtn_female:
                        viewModel.setGender(viewModel.GENDER_FEMALE);
                        break;
                    case R.id.rbtn_male:
                        viewModel.setGender(viewModel.GENDER_MALE);
                        break;
                }
            }
        });
