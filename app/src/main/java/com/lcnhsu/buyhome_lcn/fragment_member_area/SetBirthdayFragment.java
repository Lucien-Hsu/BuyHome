package com.lcnhsu.buyhome_lcn.fragment_member_area;
...
import com.lcnhsu.buyhome_lcn.data.MemberAreaViewModel;
...
public class SetBirthdayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_set_birthday, container, false);
        ...
        tvOldValue.setText(viewModel.getBirthday());
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                viewModel.setBirthday(etNewValue.getText().toString());
