...
public class CheckDealAdapter extends RecyclerView.Adapter<CheckDealAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public CheckDealAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //填充項目View
    ...
    @Override
    public void onBindViewHolder(@NonNull CheckDealAdapter.ViewHolder holder, int position) {
        //TODO
